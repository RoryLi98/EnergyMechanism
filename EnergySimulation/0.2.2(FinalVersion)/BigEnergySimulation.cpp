...
//        cout<<"now:"<<now<<endl;
    ...
    //        else guessnow = int((mark+3.335-abs(now-start))*1000)%3335/1000.0;
        ...
        cv::Point2f Prediction=getRotatePoint(clk,perim,cent,((250*cos((471*(guessnow+DelayMillisecond/1000.0))/250)-783*(guessnow+DelayMillisecond/1000.0))/600 + 25/60)*180/CV_PI-((250*cos((471*(guessnow))/250)-783*(guessnow))/600 + 25/60)*180/CV_PI);//18 0
        cv::Point2f Right=getRotatePoint(clk,perim,cent,((250*cos((471*(now+DelayMillisecond/1000.0))/250)-783*(now+DelayMillisecond/1000.0))/600 + 25/60)*180/CV_PI-((250*cos((471*(now))/250)-783*(now))/600 + 25/60)*180/CV_PI);//18 0
